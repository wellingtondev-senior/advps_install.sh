...
cd /home/devcloud/devcloud.top || error_exit "Erro: Não foi possível acessar o diretório do projeto."
...
pm2 restart devcloud || error_exit "Erro: Falha ao reiniciar a aplicação com pm2."

# Exibir logs da aplicação
echo "Exibindo logs da aplicação..."
pm2 log devcloud || error_exit "Erro: Falha ao exibir os logs da aplicação com pm2."
