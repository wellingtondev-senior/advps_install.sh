...
PROJECT_DIR="/home/devcloud/controlapp.devcloud.top"
REPO_URL="git@github.com:wellingtondev-senior/controladora.app.devcloud.top.git"
...
pm2 start npm --name controlapp_devcloud -- run start:prod
...
# Finalizar
 log $GREEN "###########################################################"
 log $GREEN "Aplicação Contralador App:"
 log $GREEN "Acesse ao Microserviço Contralador App em: http://$IP:58553"
 log $GREEN "###########################################################"